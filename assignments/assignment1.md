...
1. _Taking Better Notes in Lecture_
   - Sometimes the teacher moves too quickly, making it difficult to take notes. Other times, I can take notes but end up focusing on writing everything down rather than truly absorbing the material. Additionally, some students face the dilemma between handwriting notes, which is better for retention, and typing, which is faster. This is a serious problem, as my friends and I have experienced it firsthand. It can even lead some students to skip lecture because it feels unproductive if they cannot absorb and record the material effectively. I believe I have an interesting insight that could lead to a compelling solution.
   - Stakeholders:
...
2. _Group Planning is a Hassle When Travelling_
...
3. _Right Price For clothing_
   - There's a lot of friction with this problem. Finding the best price for clothes can be frustrating. When shopping in person, you often have to search the store’s website to compare prices, which is time-consuming. You might also miss the same item at a cheaper price in another store, overlook available coupons, or fail to identify items that are more eco-friendly or higher quality. I think this is a serious problem and a solution could reduce friction, save money, and be useful. It's also feasible and could have a good software solution
   - Stakeholders:
...
1. _Keeping track of deadlines_
...
2. _Finding time to study with someone_
...
3. _Planning itinerary at location: Making sure it's feasible with time/budget constraints_
...
2. _Group Planning for Travelling_
...
2. _Group Planning is a Hassle For Travelling_
